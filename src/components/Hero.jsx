...
//               className="h-[240px] w-[240px] md:h-[350px] md:w-[335px] lg:w-[350px] rounded-full border-2 dark:border-slate-100 border-black overflow-hidden shadow-md"
//             >
//               <Image
//                 src={logoToDisplay}
//                 alt="hero logo"
...
//                   isHovered ? "transition-transform duration-250 ease-in" : ""
//                 }`}
//               />
//             </motion.div>
//           </motion.div>
...
//   // Throttled rotation update using requestAnimationFrame
//   const handleMouseMove = (e) => {
...
const HeroPage = () => {
  ...
  return (
    <>
      <Quotes />
      <section className="lg:flex items-center lg:h-[475px]">
        <motion.div
          ref={imageRef}
          onMouseMove={handleMouseMove}
          onMouseLeave={() => {
          ...
          onMouseEnter={() => setIsHovered(true)}
          className="flex justify-center p-4 perspective"
        >
          <motion.div
            style={{
              transformStyle: "preserve-3d",
            ...
            transition={{ type: "tween", duration: 0.5, ease: "easeIn" }}
            className="h-[240px] w-[240px] md:h-[350px] md:w-[335px] lg:w-[350px] rounded-full border-2 border-black dark:border-slate-100 overflow-hidden shadow-md"
          >
            <Image
              src={logo}
              alt="hero logo"
